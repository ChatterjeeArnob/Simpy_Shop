      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto" bis_skin_checked="1">
          <div className="lg:w-4/5 mx-auto flex flex-wrap" bis_skin_checked="1">
            <img
              alt="ecommerce"
              className="lg:w-1/2 w-full lg:h-auto h-40 object-fit object-center rounded"
              src={product?.image}
            />
            <div
            ...
            >
              ...
              <div className="flex" bis_skin_checked="1">
                ...
                <button className="flex ml-auto text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" onClick={()=>handleacart(product)} >
                  Add to cart
                </button>
